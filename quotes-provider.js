...
(function (factory) {
  ...
  var QuotesProvider = /** @class */ (function () {
    function QuotesProvider(url, requester) {
      this.url = url;
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.requester.sendRequest("".concat(this.url, "/quotes"), {
                ...
                return [
                  ...
                  response.d.map(function (item) {
                    return {
                      ...
                      prev_close: item.v.prev_close_price,
                      exchange: item.v.exchange,
            ...
            case 2:
              error_1 = _a.sent();
              console.error("Failed to get quotes:", error_1);
              return [2 /*return*/, []];
            case 3:
              return [2 /*return*/];
          }
  ...
  if (typeof window !== "undefined") {
    window.QuotesProvider = QuotesProvider;
  }
});
